...
class FeedCard extends StatelessWidget {
  ...
  // ROMBAKAN V6.1: Meniru layout CSS dengan Stack agar headline 
  // bertindih ke atas imej tanpa sekatan blok menegak.
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Stack membenarkan kita mereplika "float: right" HTML.
          Stack(
            children: [
              // Lapisan Latar (Bawah): Hero Image 76% kanan
              Padding(
                padding: const EdgeInsets.only(top: 18, bottom: 20),
                child: _heroImage(isVideo: isVideo),
              ),

              // Lapisan Hadapan (Atas): Konten Teks
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Anjakan ke bawah supaya headline menindih 
                    // pada komposisi yang estetik atas imej hero.

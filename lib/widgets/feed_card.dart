...
// Latar KONSISTEN utk kad petikan — sengaja BUKAN random palette macam
// kad media. Petikan perlu identiti tunggal yang terus dikenali (gold
// gelap = "ini kandungan hikmah"), bukan pelbagai warna ikut hash id.
const List<Color> _quoteGradient = [Color(0xFF241C0C), Color(0xFF120D05)];

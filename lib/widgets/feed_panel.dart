...
// ListWheelScrollView — rubber belt cylinder effect
// item wrap around virtual cylinder, flat bila center, curve bila 'on go'
...
class _FeedPanelState extends State<FeedPanel> {
  ...
  // Diameter ratio: makin kecil = silinder makin ketat = curve makin agresif
  // 1.5 = ketat (rubber belt motosikal)
  // 2.5 = longgar (belt enjin kereta)
  // Cuba 1.8 dulu — tengah-tengah, nampak natural
  static const double _diameterRatio = 1.8;

  // Magnification: kad center nampak lebih besar / lebih dekat
  ...
  Widget build(BuildContext context) {
    ...
    // itemExtent = tinggi setiap kad — 23% skrin
    ...
    return SizedBox.expand(
      child: ListWheelScrollView.useDelegate(
        ...
        perspective: 0.002,           // kedalaman 3D — jangan lebih 0.01
        magnification: _magnification,
        useMagnifier: true,           // kad center nampak flat & lebih dekat
        physics: const FixedExtentScrollPhysics(), // snap ke item
